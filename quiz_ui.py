...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.buttons()
         # Timer label
        self.timer_label = Label(self.window, text="", font=("ariel", 16, "bold"))
        self.timer_label.place(x=700, y=20)

          # Score label
        self.score = 0
        self.score_label = Label(self.window, text="Score: 0", font=("ariel", 16, "bold"))
        self.score_label.place(x=700, y=100)

        # Initialize timer
        self.remaining_time = 60  # Change this to set the timer duration (in seconds)
        self.update_timer()
    ...
    def next_btn(self):
        ...
        if self.quiz.check_answer(self.user_answer.get()):
            ...
            # call update score label to update the score label
